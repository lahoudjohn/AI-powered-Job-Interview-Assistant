...
def generate(topic_input1):
    Prompt_ge = f"Generate exactly 5 job interview questions on the topic: {topic_input1}. Each question should be separated by a newline. Please do not include any additional information or context. Make sure to provide 5 questions and not more not less"
...
with gr.Blocks() as demo:
  with gr.Row():
    ...
    with gr.Tab("Question/Answer Bot:"):
            gr.Markdown("Select a topic, and the assistant will provide you with 5 questions:")
